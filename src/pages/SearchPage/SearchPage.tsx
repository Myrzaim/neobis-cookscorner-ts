  ...
  return (
      <div className={styles.container}>
          ...
          <div className={styles.container__category}>
              <button className={styles.container__category_chefs}>Chefs</button>
              <button className={styles.container__category_recipe}>Recipes</button>
          </div>
