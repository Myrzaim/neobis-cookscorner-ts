        ...
        <Box sx={style}>
          <div className={styles.modalContainer}>
            ...
            <form className={styles.modalContainer__form}>
              ...
              <input
                className={styles.modalContainer__form_name}
                type="text"
                value="Pancakes"
              />
              <label>Change your bio</label>
              <textarea
                className={styles.modalContainer__form_bio}
                readOnly={false}
